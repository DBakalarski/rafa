        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {[
              ...
              <div
                key={item.title}
                className="p-5 rounded-2xl transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_8px_30px_-8px_rgba(200,149,108,0.25)]"
                style={{ backgroundColor: "var(--color-a-bg)" }}
              >
                <span className="text-2xl mb-3 block transition-transform duration-200 hover:scale-110">
                  {item.icon}
                </span>

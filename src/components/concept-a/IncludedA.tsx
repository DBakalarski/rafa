      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {INCLUDED_AMENITIES.map((amenity) => (
            <div
              key={amenity.label}
              className="flex flex-col items-center text-center p-5 rounded-2xl transition-[transform,background-color] duration-200 hover:-translate-y-0.5"
              style={{ backgroundColor: "var(--color-a-surface)" }}
            >
              <span className="text-3xl mb-3 transition-transform duration-200 hover:scale-110 block">

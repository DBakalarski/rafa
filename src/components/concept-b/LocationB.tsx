        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeIn direction="left" delay={0}>
            <ParallaxLayer speed={0.2}>
              <div
                className="h-72 lg:h-96 rounded-2xl flex items-center justify-center animate-scale-in"
                style={{
                  background: `
          ...
          <div>
            ...
            >
              {DIRECTIONS.map((item) => (
                <div key={item.text} className="flex items-start gap-3">
                  <span className="text-xl shrink-0 animate-scale-in">{item.icon}</span>
            ...
            <FadeIn direction="up" delay={350}>
              <a
                href="#"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-bold text-sm border transition-[colors,transform] duration-150 hover:scale-[1.02] active:scale-[0.98] group"
                style={{
